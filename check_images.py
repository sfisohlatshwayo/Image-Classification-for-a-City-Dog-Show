...
# PROGRAMMER: Sfiso Immanuel Hlatshwayo 
...
def main():
    ...
    tableA = [["# Total Images",40],["# Dog Images",30],["# Not-a-Dog Images",10]]
    headers= ["", ""]
